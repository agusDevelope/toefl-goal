...
const courseDetails = [
  ...
  { icon: BookOpen, label: 'Sesiones', value: '5 horas diarias' },
    ...
    <section id="cursos" className="py-24 md:py-32 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-heading font-800 text-4xl md:text-5xl text-foreground mb-4">
            Curso TOEFL ITP
          </h2>
        ...
        >
          ...
          <div className="bg-primary text-primary-foreground px-8 py-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h3 className="font-heading font-800 text-2xl">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              {courseDetails.map((d) => (
                <div key={d.label} className="text-center">
                  ...
                  <p className="font-heading font-600 text-sm text-foreground">
                    {d.value}
                  </p>
                </div>
              ))}
            ...
            <div className="border-t border-border pt-8">
              <h4 className="font-heading font-700 text-lg text-foreground mb-4">
                Requisitos
              </h4>
